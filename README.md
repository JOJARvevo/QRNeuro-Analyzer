...
Android: На данном этапе разработки продукта, приложение доступно для скачивания только вручную из данного репозитория. В будующем оно будет опубликовано в Google Play.
...
Проверьте освещение, очистите камеру, попробуйте другой угол.
